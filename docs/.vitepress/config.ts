export default {
  lang: 'en-US',
  title: 'VueThree',
  description: 'computer hardware documentation',
  base: "/hardware",
  markdown: {
    lineNumbers: true
  },
  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        // { text: '6. 插槽', link: '/optionsAPI/component/slot' },
        // { text: '7. 动效', link: '/optionsAPI/component/effect' },
        // { text: '8. 组件通信', link: '/optionsAPI/component/communicate' },
